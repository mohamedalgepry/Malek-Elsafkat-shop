<?php
$pageTitle = 'تعديل السلايد';
require __DIR__ . '/../layouts/header.php';
$formData = $_SESSION['form_data'] ?? $slider;
...
<div class="card">
    <form method="POST" action="<?= BASE_URL ?>/admin/sliders/update/<?= $slider['id'] ?>" enctype="multipart/form-data" class="admin-form">
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       name="button_text" 
                       class="form-control" 
                       value="<?= escape($formData['button_text']) ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       name="button_link" 
                       class="form-control" 
                       value="<?= escape($formData['button_link']) ?>"
                       placeholder="/shop">
            </div>
        </div>
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <input type="number" 
                       ...
                       name="display_order" 
                       class="form-control" 
                       value="<?= escape($formData['display_order']) ?>"
                       min="0">
        ...
        <div class="form-group">
            ...
            <div class="file-upload">
                ...
                <div id="imagePreview" class="image-preview" style="display: block;">
                    <img src="<?= BASE_URL ?><?= escape($slider['image']) ?>" alt="معاينة">
...
function removePreview() {
    ...
    input.value = '';
    preview.querySelector('img').src = '<?= BASE_URL ?><?= escape($slider['image']) ?>';
}
</script>
